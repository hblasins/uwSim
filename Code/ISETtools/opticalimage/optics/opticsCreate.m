...
%
%      {'shift invariant'}      - A shift invariant representation based on
%      but the OTF definition is not diffraction limited 
%
...
switch lower(opticsType)
    ...
    case 'shiftinvariant'
        ...
        %         pupilDiameter = 3*1e-3;
        %         optics = opticsHuman(pupilDiameter);
        %         optics = opticsSet(optics,'model','shiftInvariant');
        %         optics = opticsSet(optics,'name','Shift invariant');
