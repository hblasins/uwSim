...
% The VSF is a 2D matrix with the rows being the angles (0 to 179 degrees) 
% and the columns being wavelength samples.
...
% This first row (after the first value) should be the wavelength samples. 
% We need this to create the spectrum from sampled values.
% E.g.
%
% 30
% 400 410 420 ... 700
...
%
% WARNING: VSF rows MUST be in degrees, at 1 degree intervals 
