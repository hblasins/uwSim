%% Render underwater chart with varying camera distances.

% This script renders 5 images with different distances between the camera
% and the chart.
...
assert(nConditions == length(cameraDistance));
