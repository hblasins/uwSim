...
% This script renders 5 images with different chlorophyll concentrations.
...
destPath = fullfile(parentPath,'Results','Chlorophyll');
...
hints.recipeName = 'uwSim-Chlorophyll'; % Name of the render
...
assert(nConditions == length(chlorophyll));
