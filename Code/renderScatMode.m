...
% This script renders 5 images with different particle concentrations.
...
scatteringMode = {'default','forward','backward','direct'};

flashDistanceFromChart = ones(1,nConditions).*cameraDistance;
flashDistanceFromCamera = ones(1,nConditions).*20; % mm
...
for i = 1:nConditions
    ...
    oiName = sprintf('%s_%0.2f_%0.2f_%0.2f_%0.2f_%0.2f_%0.2f_%0.2f_%0.2f_%s', ...
        hints.recipeName, ...
